...
class IdeaService {
  ...
  Future<Idea> update(Idea idea, String updateWhat, String updateTo) async {
    switch (updateWhat.toLowerCase()) {
      case 'title':
        {
          idea = await _updateTitle(idea, updateTo);
          return idea;
        }
        break;
      case 'description':
        {
          idea = await _updateDescription(idea, updateTo);
          return idea;
        }
        break;
      case 'vote':
        {
          idea = await _updateVotes(idea, updateTo);
          return idea;
        }
        break;
      default:
